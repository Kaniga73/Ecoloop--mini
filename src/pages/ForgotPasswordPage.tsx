    ...
    >
      <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200/80 shadow-[0_4px_24px_-4px_rgba(15,23,42,0.06)] p-5 sm:p-6">
        <div className="text-center mb-6">
          ...
          <h1 className="text-lg font-bold text-slate-900 tracking-normal font-sans">
            Forgot Password
          </h1>
        ...
        {error && (
          <div className="mb-4 p-3.5 bg-rose-50 border border-rose-200 rounded-xl flex items-center gap-2.5 text-rose-800 text-[13px]">
        ...
        {success ? (
          <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-2xl text-center space-y-3 max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 max-w-md mx-auto">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-2 bg-slate-50/50 hover:bg-slate-50 focus:bg-white text-slate-900 text-sm rounded-xl border border-slate-200 focus:border-emerald-600 focus:ring-3 focus:ring-emerald-600/10 transition-all outline-none"
                />
              </div>
            </div>
            ...
            <div className="flex justify-center pt-2">
              <button
                type="submit"
                disabled={loading}
                className="w-56 py-2.5 px-6 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-xl shadow-sm transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
                {loading ? (
                  <>
